...
def run_experiment(target, data, device, model_savepath=None, run_id=0):
    ...
    test_dataset = Dataset_NLP(num_samples=num_test_samples, num_cats=num_cats, low=low_test, high=high_test, target=target, num_additional_node=num_additional_node, num_query_cats=num_query_cats, reject_low=low_train, reject_high=high_train)
    ...
    test_loader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, variable_length=False)
